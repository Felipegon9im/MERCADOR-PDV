    ...
    callAsaas: async (method, endpoint, body) => {
      ...
      if (endpoint.endsWith('/pixQrCode')) {
        return {
          success: true,
          data: {
            encodedImage: 'https://api.qrserver.com/v1/create-qr-code/?size=200x200&data=00020101021226870014br.gov.bcb.pix2563mock-payload-copied-and-pasted-mercado-pdv-mensalidade',
